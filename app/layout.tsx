...
export const metadata: Metadata = {
    ...
    icons: {
        icon: [
            { url: '/images/Yoga Site Logo.jpg', sizes: '48x48' },
            { url: '/images/Yoga Site Logo.jpg', sizes: '192x192', type: 'image/png' },
            { url: '/images/Yoga Site Logo.jpg', sizes: '512x512', type: 'image/png' },
        ],
        apple: [
            { url: '/images/Yoga Site Logo.jpg', sizes: '180x180', type: 'image/png' },
        ],
    },
