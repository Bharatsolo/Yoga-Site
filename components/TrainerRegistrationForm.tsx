    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                // Reset form
                setFormData({
                    fullName: '', age: '', gender: '', phone: '', countryCode: '+91', email: '', city: '', address: '', experience: '', specialization: '', bio: ''
                });
                formElement.reset();
            } else {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl border border-gold/20 overflow-hidden relative max-w-3xl mx-auto animate-fade-in-up">
            <div className="bg-warm-bg p-8 text-center border-b border-gold/10">
                ...
                <a
                    href="https://chat.whatsapp.com/KqD2AdgYtJtB5REdusbwMS"
                    target="_blank"
                ...
                >
                    ...
                    Join our Trainers Community on WhatsApp
                </a>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div className="relative flex items-center w-full px-4 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus-within:ring-2 focus-within:ring-gold/50 focus-within:border-gold/50 transition-all">
                                <select name="countryCode" value={formData.countryCode} onChange={handleChange} className="bg-transparent border-none outline-none text-gray-600 appearance-none text-sm pr-2 cursor-pointer w-[45px] focus:ring-0 truncate" style={{ scrollbarWidth: 'none' }}>
                                ...
                                <input required type="tel" id="phone" name="phone" value={formData.phone} onChange={handleChange} className="flex-1 bg-transparent border-none focus:outline-none focus:ring-0 text-dark-bg p-0 m-0 w-full" placeholder="9876543210" />
                            </div>
                        </div>
                        <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input required type="text" id="city" name="city" value={formData.city} onChange={handleChange} className="w-full px-4 py-3 bg-gray-50/50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold/50 transition-all text-dark-bg" placeholder="e.g. Bangalore" />
                        </div>
                        <div>
